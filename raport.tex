...
\hline
\textbf{Centralisation} & Plusieurs applications distinctes selon les marques de capteurs & Application unique Tapo, mais limitée à l'écosystème TP-Link & \textbf{Interface unique} regroupant caméras, infomartions systemes et alertes \\
\hline
...
\hline
Tests API & Postman & Contrats d'interface REST : auth, caméras, capteurs, utilisateurs (voir annexe~\ref{annexe:tests-api}). \\
\hline
...
\begin{itemize}[label=\textbullet]
    ...
    \item \textbf{Monitoring :} PM2 surveille l'état du processus Node.js et redémarre automatiquement en cas de crash. Les alertes système (caméra hors ligne, batterie faible) sont remontées en temps réel via le dashboard et les notifications push.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/test_secu_1_no_token.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/test_secu_2_fake_token.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/test_secu_3_sql_injection.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/test_secu_4_auth_ok.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/test_secu_5_rate_limit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/test_api_cameras.png}
    \caption{Test API : \texttt{GET /api/cameras} --- liste des caméras configurées}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/test_api_nodes.png}
    \caption{Test API : \texttt{GET /api/camera-nodes} --- liste des nœuds actifs}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/test_api_alerts.png}
