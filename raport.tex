...
\begin{description}[leftmargin=2.5cm, style=nextline]
    ...
    Singleton de configuration globale de l'application (une seule ligne, contrainte \texttt{CHECK (id = 1)}). Regroupe les paramètres d'interface (thème, densité, format d'heure), les seuils d'alerte (temps de reconnexion caméra, intervalle de découverte), les options de notification (alertes temps réel, résumé quotidien, son), le mode surveillance, et les paramètres du boîtier kiosque (PIN, utilisateur admin par défaut).
\end{description}
